  ...
  $(document).ready(function(){
    ...
    $(function() {
      $("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
          ...
          $.post("updateNavDb.php", order, function(theResponse){
...
<?php
$topNavTable = 1;
$Sql = mysql_query("select * from topNav WHERE navArray != '' AND type='top'");
...
<div class="bc_heading">Manage Navigation</div>
<p style="text-align:center; font-style:italic; font-size:12px; color:#666666;"> * Top 6 Links will show in Navigation * </p>
